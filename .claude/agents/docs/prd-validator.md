...
> **day3box 프로젝트 주의**: 이 프로젝트의 정본 PRD는 `docs/PRD_2.md`다. day3box PRD 검증 시에는
> (a) 이미 "근거 + 배제한 대안"이 기록된 확정 결정(4.1, 5장, 7장)을 재검증 대상이 아니라 전제로 취급하고,
> (b) 설치된 실제 버전(`package.json`: Next.js 16.2.11)과 `node_modules/next/dist/docs/`를 사실 확인의 1차 소스로 사용한다.
...
- [FACT] Next.js 16은 Server Actions를 지원함 (node_modules/next/dist/docs 확인)
